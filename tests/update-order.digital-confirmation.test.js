        ...
        return {
          select: vi.fn(() => ({
            eq: vi.fn(() => ({
              single: vi.fn(() =>
                Promise.resolve({
                  data: { id: "biz-confirm-1", slug: "majesty", name: "Majesty", active: true },
                  error: null
                })
              )
            }))
...
vi.mock("../netlify/functions/_utils.js", () => ({
  ...
  getBusinessBySlug: vi.fn().mockResolvedValue({ id: "biz-confirm-1", slug: "majesty", name: "Majesty", active: true }),
